...
async function initializeTemplateButton() {
  ...
  templateButton.addEventListener('click', (event) => {
    ...
    dropdown.innerHTML = `
      ...
      <div class="grid sm:grid-cols-2 mt-0.5 pb-1 px-1">
        <div class="min-h-0">
          ...
          ">
            <div role="menuitem" class="py-1 px-2 rounded-md cursor-pointer whitespace-nowrap overflow-hidden text-ellipsis grid grid-cols-[minmax(0,_1fr)_auto] gap-2 items-center outline-none select-none pr-0 mb-0.5 line-clamp-2 leading-tight hover:bg-bg-300" tabindex="-1">
              <div class="flex items-center justify-between">
                <div class="flex-1 text-wrap line-clamp-2">Template 1</div>
              </div>
            </div>
            <div role="menuitem" class="py-1 px-2 rounded-md cursor-pointer whitespace-nowrap overflow-hidden text-ellipsis grid grid-cols-[minmax(0,_1fr)_auto] gap-2 items-center outline-none select-none pr-0 mb-0.5 line-clamp-2 leading-tight hover:bg-bg-300" tabindex="-1">
              <div class="flex items-center justify-between">
                <div class="flex-1 text-wrap line-clamp-2">Template 2</div>
              </div>
            </div>
          </div>
    ...
    // Add dropdown to wrapper and wrapper to body
    ...
    dropdownWrapper.style.opacity = '1'; // 位置を設定後に表示
