...
async function createTemplateDropdown(templates) {
	...
	dropdown.className =
		"absolute top-full right-0 mt-1 w-64 max-h-96 overflow-y-auto bg-white rounded-md shadow-lg border border-gray-200 z-50";
  ...
  `;
	...
	templateItems.forEach((item) => {
		item.addEventListener("click", () => {
			...
			// Remove dropdown
			const dropdownToRemove = document.querySelector(
	...
	const settingsButton = dropdown.querySelector(
